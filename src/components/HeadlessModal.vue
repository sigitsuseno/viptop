  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        <div
          ref="modalRef"
          class="relative bg-blue-950 dark:bg-gray-800 rounded-lg shadow-md max-w-md w-full mx-auto overflow-hidden shadow-slate-700/50"
        >
          <!-- Close button -->
          <button
            @click="$emit('close')"
            class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none"
          >
